/* $Id: dbgkrnlinfo-r0drv-linux.c 112585 2026-01-14 23:27:03Z knut.osmundsen@oracle.com $ */
/** @file
...
#if RTLNX_VER_MIN(5,15,0) || defined(IN_RING3) /** @todo support this for older kernels (see also initterm-r0drv-linux.c and fileio-r0drv-linux.c) */
