/* $Id: dbgkrnlinfo-r0drv-linux.c 112594 2026-01-15 08:37:34Z knut.osmundsen@oracle.com $ */
/** @file
...
#if RTLNX_VER_MIN(5,10,0) || defined(IN_RING3) /** @todo support this for older kernels (see also initterm-r0drv-linux.c and fileio-r0drv-linux.c) */
