...
ossl_rsaz_amm52x40_x1_ifma256:
        ...
        mov     rax,rsp
$L$SEH_begin_ossl_rsaz_amm52x40_x1_ifma256:
        mov     rdi,rcx
        mov     rsi,rdx
        mov     rdx,r8
        mov     rcx,r9
...
$L$ossl_rsaz_amm52x40_x1_ifma256_body:
...
$L$loop10:
        ...
        valignq ymm10,ymm11,ymm10,1
        valignq ymm11,ymm12,ymm11,1
        valignq ymm12,ymm0,ymm12,1
        ...
        vpsrlq  ymm1,ymm4,52
        vpsrlq  ymm2,ymm5,52
        vpsrlq  ymm23,ymm6,52
        vpsrlq  ymm24,ymm7,52
        vpsrlq  ymm25,ymm8,52
        vpsrlq  ymm26,ymm9,52
        vpsrlq  ymm27,ymm10,52
        vpsrlq  ymm28,ymm11,52
        vpsrlq  ymm29,ymm12,52


        valignq ymm29,ymm29,ymm28,3
        valignq ymm28,ymm28,ymm27,3
        valignq ymm27,ymm27,ymm26,3
        valignq ymm26,ymm26,ymm25,3
        valignq ymm25,ymm25,ymm24,3
        valignq ymm24,ymm24,ymm23,3
        valignq ymm23,ymm23,ymm2,3
        ...
        vpaddq  ymm10,ymm10,ymm27
        vpaddq  ymm11,ymm11,ymm28
        vpaddq  ymm12,ymm12,ymm29
        ...
        vpsubq  ymm11{k2},ymm11,YMMWORD[$L$mask52x4]
        vpsubq  ymm12{k3},ymm12,YMMWORD[$L$mask52x4]
...
$L$SEH_end_ossl_rsaz_amm52x40_x1_ifma256:
...
ossl_rsaz_amm52x40_x2_ifma256:
        ...
        mov     QWORD[16+rsp],rsi
        mov     rax,rsp
$L$SEH_begin_ossl_rsaz_amm52x40_x2_ifma256:
        mov     rdi,rcx
        mov     rsi,rdx
        mov     rdx,r8
        mov     rcx,r9
...
DB      243,15,30,250
        ...
        vmovdqa64       XMMWORD[128+rsp],xmm14
        vmovdqa64       XMMWORD[144+rsp],xmm15
$L$ossl_rsaz_amm52x40_x2_ifma256_body:
...
$L$loop40:
        ...
        vpmadd52luq     ymm19,ymm1,YMMWORD[512+rsi]
        vpmadd52luq     ymm20,ymm1,YMMWORD[544+rsi]
        vpmadd52luq     ymm21,ymm1,YMMWORD[576+rsi]
        vpmadd52luq     ymm22,ymm1,YMMWORD[608+rsi]
        ...
        vpmadd52luq     ymm19,ymm2,YMMWORD[512+rcx]
        vpmadd52luq     ymm20,ymm2,YMMWORD[544+rcx]
        vpmadd52luq     ymm21,ymm2,YMMWORD[576+rcx]
        vpmadd52luq     ymm22,ymm2,YMMWORD[608+rcx]
        ...
        vpmadd52huq     ymm19,ymm1,YMMWORD[512+rsi]
        vpmadd52huq     ymm20,ymm1,YMMWORD[544+rsi]
        vpmadd52huq     ymm21,ymm1,YMMWORD[576+rsi]
        vpmadd52huq     ymm22,ymm1,YMMWORD[608+rsi]
        ...
        vpmadd52huq     ymm19,ymm2,YMMWORD[512+rcx]
        vpmadd52huq     ymm20,ymm2,YMMWORD[544+rcx]
        vpmadd52huq     ymm21,ymm2,YMMWORD[576+rcx]
        vpmadd52huq     ymm22,ymm2,YMMWORD[608+rcx]
        lea     r11,[8+r11]
        dec     ebx
        jne     NEAR $L$loop40
        ...
        vpblendd        ymm13,ymm13,ymm0,3



        vpsrlq  ymm0,ymm13,52
        vpsrlq  ymm1,ymm14,52
        vpsrlq  ymm2,ymm15,52
        vpsrlq  ymm23,ymm16,52
        vpsrlq  ymm24,ymm17,52
        vpsrlq  ymm25,ymm18,52
        vpsrlq  ymm26,ymm19,52
        vpsrlq  ymm27,ymm20,52
        vpsrlq  ymm28,ymm21,52
        vpsrlq  ymm29,ymm22,52
        ...
        vpaddq  ymm16,ymm16,ymm23
        vpaddq  ymm17,ymm17,ymm24
        vpaddq  ymm18,ymm18,ymm25
        vpaddq  ymm19,ymm19,ymm26
        vpaddq  ymm20,ymm20,ymm27
        vpaddq  ymm21,ymm21,ymm28
        vpaddq  ymm22,ymm22,ymm29
        ...
        vpcmpuq k1,ymm19,YMMWORD[$L$mask52x4],6
        ...
        vpcmpuq k1,ymm21,YMMWORD[$L$mask52x4],6
        vpcmpuq k2,ymm22,YMMWORD[$L$mask52x4],6
        kmovb   r10d,k1
        kmovb   r9d,k2
        shl     r9b,4
        or      r10b,r9b
        ...
        vpcmpuq k1,ymm19,YMMWORD[$L$mask52x4],0
        ...
        vpcmpuq k1,ymm21,YMMWORD[$L$mask52x4],0
        vpcmpuq k2,ymm22,YMMWORD[$L$mask52x4],0
        kmovb   ebx,k1
        kmovb   eax,k2
        shl     al,4
        or      bl,al
        ...
        vpsubq  ymm13{k1},ymm13,YMMWORD[$L$mask52x4]
        vpsubq  ymm14{k2},ymm14,YMMWORD[$L$mask52x4]
        vpsubq  ymm15{k3},ymm15,YMMWORD[$L$mask52x4]
        vpsubq  ymm16{k4},ymm16,YMMWORD[$L$mask52x4]
        vpsubq  ymm17{k5},ymm17,YMMWORD[$L$mask52x4]
        vpsubq  ymm18{k6},ymm18,YMMWORD[$L$mask52x4]
        vpsubq  ymm19{k7},ymm19,YMMWORD[$L$mask52x4]
        ...
        vpsubq  ymm20{k1},ymm20,YMMWORD[$L$mask52x4]
        vpsubq  ymm21{k2},ymm21,YMMWORD[$L$mask52x4]
        vpsubq  ymm22{k3},ymm22,YMMWORD[$L$mask52x4]
        ...
        vmovdqu64       YMMWORD[512+rdi],ymm19
        vmovdqu64       YMMWORD[544+rdi],ymm20
        vmovdqu64       YMMWORD[576+rdi],ymm21
        vmovdqu64       YMMWORD[608+rdi],ymm22
...
$L$SEH_end_ossl_rsaz_amm52x40_x2_ifma256:
section .text code align=64
...
$L$loop_0:
        ...
        vpblendmq       ymm5{k1},ymm5,ymm20
        vmovdqu64       ymm20,YMMWORD[192+rdx]
        vpblendmq       ymm16{k1},ymm16,ymm20
        vmovdqu64       ymm20,YMMWORD[224+rdx]
        vpblendmq       ymm17{k1},ymm17,ymm20
        vmovdqu64       ymm20,YMMWORD[256+rdx]
        vpblendmq       ymm18{k1},ymm18,ymm20
        vmovdqu64       ymm20,YMMWORD[288+rdx]
        vpblendmq       ymm19{k1},ymm19,ymm20
...
ALIGN   32
$L$loop_320:
        vpcmpq  k1,ymm23,ymm21,0
        vmovdqu64       ymm20,YMMWORD[320+rdx]
        vpblendmq       ymm0{k1},ymm0,ymm20
        vmovdqu64       ymm20,YMMWORD[352+rdx]
        vpblendmq       ymm1{k1},ymm1,ymm20
        vmovdqu64       ymm20,YMMWORD[384+rdx]
        vpblendmq       ymm2{k1},ymm2,ymm20
        vmovdqu64       ymm20,YMMWORD[416+rdx]
        vpblendmq       ymm3{k1},ymm3,ymm20
        vmovdqu64       ymm20,YMMWORD[448+rdx]
        vpblendmq       ymm4{k1},ymm4,ymm20
        vmovdqu64       ymm20,YMMWORD[480+rdx]
        vpblendmq       ymm5{k1},ymm5,ymm20
        vmovdqu64       ymm20,YMMWORD[512+rdx]
        vpblendmq       ymm16{k1},ymm16,ymm20
        vmovdqu64       ymm20,YMMWORD[544+rdx]
        vpblendmq       ymm17{k1},ymm17,ymm20
        vmovdqu64       ymm20,YMMWORD[576+rdx]
        vpblendmq       ymm18{k1},ymm18,ymm20
        vmovdqu64       ymm20,YMMWORD[608+rdx]
        vpblendmq       ymm19{k1},ymm19,ymm20
        vpaddq  ymm21,ymm21,ymm24
        add     rdx,640
        cmp     rax,rdx
        jne     NEAR $L$loop_320
        vmovdqu64       YMMWORD[320+rcx],ymm0
        vmovdqu64       YMMWORD[352+rcx],ymm1
        vmovdqu64       YMMWORD[384+rcx],ymm2
        vmovdqu64       YMMWORD[416+rcx],ymm3
        vmovdqu64       YMMWORD[448+rcx],ymm4
        vmovdqu64       YMMWORD[480+rcx],ymm5
        vmovdqu64       YMMWORD[512+rcx],ymm16
        vmovdqu64       YMMWORD[544+rcx],ymm17
        vmovdqu64       YMMWORD[576+rcx],ymm18
        vmovdqu64       YMMWORD[608+rcx],ymm19
...
ALIGN   4
        DD      $L$SEH_begin_ossl_rsaz_amm52x40_x1_ifma256 wrt ..imagebase
        ...
        DD      $L$SEH_end_ossl_rsaz_amm52x40_x2_ifma256 wrt ..imagebase
        DD      $L$SEH_info_ossl_rsaz_amm52x40_x2_ifma256 wrt ..imagebase

section .xdata rdata align=8
ALIGN   8
$L$SEH_info_ossl_rsaz_amm52x40_x1_ifma256:
DB      9,0,0,0
        DD      rsaz_avx_handler wrt ..imagebase
        DD      $L$ossl_rsaz_amm52x40_x1_ifma256_body wrt ..imagebase,$L$ossl_rsaz_amm52x40_x1_ifma256_epilogue wrt ..imagebase
$L$SEH_info_ossl_rsaz_amm52x40_x2_ifma256:
DB      9,0,0,0
        DD      rsaz_avx_handler wrt ..imagebase
        DD      $L$ossl_rsaz_amm52x40_x2_ifma256_body wrt ..imagebase,$L$ossl_rsaz_amm52x40_x2_ifma256_epilogue wrt ..imagebase
